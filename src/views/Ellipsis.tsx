    ...
    return (
        <div>
            ...
            <main>
                ...
                <Widget height={2} width={2} left={0} top={0} showLightbox={true}></Widget>
                <Widget height={1} width={1} left={2} top={0} showLightbox={false}></Widget>
                <Widget height={1} width={1} left={3} top={0} showLightbox={false}></Widget>
                ...
                <Widget height={1} width={1} left={3} top={1} showLightbox={false}></Widget>
                ...
                <Widget height={1} width={2} left={0} top={3} showLightbox={true}></Widget>
                ...
                <Widget height={2} width={3} left={0} top={4} showLightbox={true}></Widget>
